pipeline {
  ...
  stages {
    ...
    stage ('Build') {
      ...
      sh 'python3 dojo_ci_cd.py --product=1 --file "/tests/scans/trufflehog.xml" --scanner="trufflehog Scan" --high=0 --host=http://localhost:8000 --api_key=<1222c567c6b54b30ef9d6f8a2f867e2a3f850406> --user=admin'  
